...
import type { Document as _Document, DocumentId as _DocumentId, ExternalBlob as _ExternalBlob, FolderName as _FolderName, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createDocument(arg0: string, arg1: FolderName, arg2: ExternalBlob): Promise<DocumentId> {
        if (this.processError) {
            try {
                const result = await this.actor.createDocument(arg0, arg1, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createFolder(arg0: FolderName): Promise<void> {
        if (this.processError) {
            try {
    ...
    async listFolders(): Promise<Array<Type>> {
        if (this.processError) {
            try {
    ...
    async listUserDocuments(): Promise<Array<Document>> {
        if (this.processError) {
            try {
    ...
    async moveDocument(arg0: DocumentId, arg1: FolderName): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.moveDocument(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async renameDocument(arg0: DocumentId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_Document_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Document): Promise<Document> {
...
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Document>): Promise<Array<Document>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Document_n15(_uploadFile, _downloadFile, x)));
}
